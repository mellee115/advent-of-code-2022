    ...
    <>
      <div className='puzzle'>
        ...
        <p>
          ...
          <ul>
            <li>lvJrwpWtwJgWrhcsFMMfFFhFp</li>
            <li>jqHRNqRjqzjGDLGLrsFMfFZSrLrFZsSL</li>
            <li>PmmdzqPrVvPwwTWBwg</li>
            <li>wMqvLMZHhHMvwLHjbvcjnnSBnvTQFn</li>
            <li>ttgJtRGJQctTZtZT</li>
            <li>CrZsJsPPZsGzwwsLwLmpwMDw</li>
          </ul>
        </p>
        <p>
